...
class ViewDialog extends StatefulWidget {
  ViewDialog({Key key, this.img, this.imgs, this.width, this.onlyView}) : super(key: key);
  final img;
  final imgs;
  final width;
  final bool onlyView;
      ...
      array.add(
        Listener(
          ...
          child: GestureDetector(
            ...
            child: Container(
              width: w,
              child: i['url'] != null ? Image.network(i['url']) : Image.asset(i['file']),
            ),
          ),
        ),
      );
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          ...
          widget.onlyView ? Container() : Positioned(
            top: 20,
            right: 20,
            child: Container(
